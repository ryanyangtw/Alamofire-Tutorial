...
struct Five100px {
  ...
  // Router create appropriate instances of URLString for your API calls
  // It's a simple enum that conforms the URLRequestConvertible which a protocol defined inside Alamofire
  // When the enum adopts this protocol, it must have a variable of type NSURLequest named URLRequest
  enum Router: URLRequestConvertible {
    
    static let baseURLString = "https://api.500px.com/v1"
    static let consumerKey = "zSxP3SHwZRxLi2KlGGBOTzhc6JkNETH7F0qLQQ3Q"
